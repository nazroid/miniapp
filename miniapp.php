...
$landingExampleURL = "https://ViRus32.blog.ir";
...
if (empty($url)) {
    if (empty($startURL)) {
      die("<html><head><title>miniProxy - ViRus32 & MR_C0D3R</title></head><body bgcolor=\"black\"><h1 style=\"color:red\">Welcome to <span style=\"color:lawngreen;\">miniProxy</span> !</h1><span style=\"color:red\">miniProxy can be directly invoked like this: </span><a href=\"" . PROXY_PREFIX . $landingExampleURL . "\">" . PROXY_PREFIX . $landingExampleURL . "</a><br /><br /><span style=\"color:red\">Or, you can simply enter a URL below:</span><br /><br /><form onsubmit=\"if (document.getElementById('site').value) { window.location.href='" . PROXY_PREFIX . "' + document.getElementById('site').value; return false; } else { window.location.href='" . PROXY_PREFIX . $landingExampleURL . "'; return false; }\" autocomplete=\"off\"><input id=\"site\" type=\"text\" size=\"50\" /><input type=\"submit\" value=\"Proxy It!\" /></form><hr color=\"red\" /><a href=\"https://virus32.blog.ir\" target=\"_blank\"><span style=\"color:orange\">Join to ViRus32 Blog...</span></a>  </body></html>");
    } else {
      $url = $startURL;
    }
